...
@IonicPage()
@Component({
  selector: 'page-user-house-detail',
  templateUrl: 'user-house-detail.html',
})
export class UserHouseDetailPage {
  ...
  inRegister() {
    this.navCtrl.push('NewEnterRegisterPage');
  }

  outRegister() {
    this.navCtrl.push('NewLeaveRegisterPage');
  }
